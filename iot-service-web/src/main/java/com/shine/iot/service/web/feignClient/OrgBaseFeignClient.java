...
import com.shine.iot.service.web.hystix.OrgBaseFeignClientFallback;
...
//@FeignClient(value = "iot-service-api-impl", path = "org-base-data")
public interface OrgBaseFeignClient {
